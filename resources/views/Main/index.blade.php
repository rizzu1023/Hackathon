...
<!--[if gt IE 8]><!-->	<html class="no-')}}" lang="zxx"> <!--<![endif]-->


<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<title>Bonhomie FIctures</title>
	...
	<link rel="stylesheet" href="{{asset('Main/css/transitions.css')}}">
	<link rel="stylesheet" href="{{asset('Main/css/prettyPhoto.css')}}">
	...
	<link rel="stylesheet" href="{{asset('Main/css/owl.theme.css')}}">
	<link rel="stylesheet" href="{{asset('Main/css/owl.carousel.css')}}">
	<link rel="stylesheet" href="{{asset('Main/css/customScrollbar.css')}}">
	...
	<script src="{{asset('js/vendor/modernizr-2.8.3-respond-1.4.2.min.')}}"></script>
</head>
<body>
	<!--[if lt IE 8]>
						...
						<nav id="tg-nav" class="tg-nav brand-center">
							<div class="navbar-header">
								...
								<strong class="tg-logo">
									<a href="index-2.html"><img src="images/logo2.png" alt="image description"></a>
								</strong>
							</div>
							<div id="tg-navigation" class="tg-navigation">
								<div class="tg-colhalf">
                                    <ul>
                                        ...
                                        <li>
											<a href="playergrid-v1.html">TEAM</a>
					...
					<div class="swiper-slide">
						<div class="container">
							...
							<div class="tg-slider-content">
								<h1>Bon<span>homie</span><h2 class="datee">from JAN 27</h2></h1>
								<div class="tg-btnbox">
								...
								<div class="row">
									...
									<div class="col-md-6 col-sm-12 col-xs-12">
										<div class="tg-contentbox">
											<div class="tg-section-heading"><h2>Bonhomie Sports</h2></div>
						...
						<div class="row">
							<div class="tg-upcomingmatch-counter">
								...
								<div class="col-md-8 col-sm-8 col-xs-12">
									<div class="tg-contentbox">
										<div class="tg-section-heading"><h2>BE CO <span>VS</span> TE CO</h2></div>
										<div class="tg-description">
										...
										<div class="tg-btnbox">
											<a class="tg-btn" href="fixtures.html"><span>read more</span></a>
										</div>
									</div>
								</div>
							</div>
...
<!-- 
			<section class="tg-main-section tg-soccermedia tg-haslayout">
						...
						<div class="row">
							<div class="tg-tg-soccermedia-head tg-haslayout">
								<ul id="tg-filterbale-nav" class="tg-filterbale-nav option-set">
									...
									<li><a data-filter=".co" href="javascript:void(0);">CO</a></li>
									<li><a data-filter=".extc" href="javascript:void(0);">EXTC</a></li>
									<li><a data-filter=".mech" href="javascript:void(0);">MECHANICAL</a></li>
									<li><a data-filter=".elect" href="javascript:void(0);">ELECTRICAL</a></li>
									<li><a data-filter=".civil" href="javascript:void(0);">CIVIL</a></li>
									<li><a data-filter=".arch" href="javascript:void(0);">ARCH</a></li>
									<li><a data-filter=".pharm" href="javascript:void(0);">PHARM</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div id="tg-soccermediascrollbar" class="tg-soccermediascrollbar">
					<div id="filter-masonry" class="tg-soccermedia-content tg-haslayout">
						<div class="masonry-grid co">
							<div class="tg-project">
								
							</div>
						</div>
						<div class="masonry-grid extc">
							<div class="tg-project">
						...
						<div class="masonry-grid pharm">
							<div class="tg-project">
								
							</div>
						</div>
						<div class="masonry-grid mech">
							<div class="tg-project">
								
							</div>
						</div>
						<div class="masonry-grid arch">
							<div class="tg-project">
							...
							<div class="tg-latestresult">
								<div class="row">
									<div class="col-md-5 col-sm-12 col-xs-12">
										<div class="tg-contentbox">
											<div class="tg-section-heading"><h2>UPCOMING FIXTURES</h2></div>
											<div class="tg-description">
											...
											<div class="tg-btnbox">
												<a class="tg-btn" href="fixturedetail.html"><span>view all</span></a>
											</div>
										</div>
									</div>
												...
												<div class="swiper-slide">
													<div class="tg-match">
														...
														<div class="tg-matchhover">
															<address>Jan16, 2017 15:30 PM Soccer Stadium, Dubai</address>
															<div class="tg-btnbox">
																<a class="tg-btn" href="fixturedetail.html"><span>read more</span></a>
															</div>
														</div>
													</div>
												</div>
			...
			*************************************-->
			<section class="tg-videobox tg-haslayout">
				<figure>
					...
					<figcaption>
						<a class="tg-playbtn" href="https://www.youtube.com/watch?v=ZXUYcAzIQ1Q" data-rel="prettyPhoto[iframe]"></a>
						<h2>Live Events</h2>
					</figcaption>
				</figure>
			</section>
								...
								<div class="tg-footercol">
									...
									<ul class="tg-contactinfo">
										<li>
											...
											<address>Plot No. 2 & 3, Sector - 16, Near Thana Naka, Khandagao, New Panvel, Navi Mumbai, Maharashtra 410206</address>
										</li>
										<li>
											<i class="fa fa-envelope-o"></i>
											<a href="info%40aiktc.html">info@aiktc.com</a>
										</li>
										<li>
	...
	*************************************-->
	...
	<!--************************************
		LightBoxes End
	*************************************-->
	<script src="{{asset('js/vendor/jquery-library.')}}"></script>
	<script src="{{asset('js/vendor/bootstrap.min.')}}"></script>
	<script src="{{asset('js/customScrollbar.min.')}}"></script>
	<script src="{{asset('js/owl.carousel.')}}"></script>
	<script src="{{asset('js/isotope.pkgd.')}}"></script>
	<script src="{{asset('js/prettyPhoto.')}}"></script>
	<script src="{{asset('js/swiper.min.')}}"></script>
	<script src="{{asset('js/jquery-ui.')}}"></script>
	<script src="{{asset('js/countTo.')}}"></script>
	<script src="{{asset('js/appear.')}}"></script>
